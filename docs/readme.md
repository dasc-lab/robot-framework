...
Using the incredible "Just The Docs" theme: https://github.com/just-the-docs/just-the-docs

## Local Development
Either follow instructions on the original repo, or simply run:

```
docker-compose up
```

And then open the server-address that shows up in the terminal, most-likely:
```
http://0.0.0.0:4001/docs/
```


## Making Changes
Add all documentation in the `./docs` folder

## Pushing Changes to the actual website:
simply push all the changes to github. Only changes to master will show up on the website.
